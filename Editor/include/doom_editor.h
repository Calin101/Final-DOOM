...
/*   Updated: 2020/06/29 20:11:25 by user42           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void					first_dot_wall_ter_2(int x, int y,
						t_file *file, int fd);
...
int						init_tab_texture(t_file *file);
...
int						check_state_int(t_file *file, int i, int j);
int						check_state_int_2(t_file *file, int i, int j);
int						check_state_int_3(t_file *file, int i, int j);
int						check_state_int_4(t_file *file, int i, int j);
int						check_state_int_5(t_file *file, int i, int j);
int						check_state_int_6(t_file *file, int i, int j);
int						check_state_int_7(t_file *file, int i, int j);
...
void					print_white_visual_textures(int x, int y,
						t_file *file, int i);
void					print_blue_visual_textures(int x, int y,
						t_file *file, int i);
void					print_white_visual_skybox(int x, int y,
						t_file *file, int i);
void					print_red_visual_skybox(int x, int y,
						t_file *file, int i);
...
void					draw_mob_and_object(int x, int y,
						t_file *file, int fd);
...
void					choose_textures_floor(t_file *file,
						int fd, int x, int y);
void					choose_textures_wall(t_file *file,
						int fd, int x, int y);
void					choose_objects_file(t_file *file, int fd,
						int x, int y);
...
void					first_dot_wall_bis_2(int x, int y,
						t_file *file, int fd);
