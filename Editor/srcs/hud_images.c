...
/*   Updated: 2020/06/29 19:51:53 by user42           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */

#include "doom_editor.h"

int			error_tex(t_file *file)
{
	if (!(mlx_xpm_file_to_image(file->mlx_ptr, file->name_texture[0],
	&file->image[0].width, &file->image[0].height)))
		exit(0);
	return (1);
}
