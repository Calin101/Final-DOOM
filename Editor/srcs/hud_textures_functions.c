...
/*   Updated: 2020/06/29 19:52:02 by user42           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int		wall_square_texture(int x, int y, t_file *file)
{
	...
	if (!(file->image[5].wall_stone = mlx_xpm_file_to_image(file->mlx_ptr,
...
int		wall_blue_texture(int x, int y, t_file *file)
{
	...
	if (!(file->image[9].wall_stone = mlx_xpm_file_to_image(file->mlx_ptr,
...
int		wall_wood_texture(int x, int y, t_file *file)
{
	...
	if (!(file->image[13].wall_stone = mlx_xpm_file_to_image(file->mlx_ptr,
...
int		wall_green_texture(int x, int y, t_file *file)
{
	...
	if (!(file->image[15].wall_stone = mlx_xpm_file_to_image(file->mlx_ptr,
...
int		wall_quartz_texture(int x, int y, t_file *file)
{
	...
	if (!(file->image[19].wall_stone = mlx_xpm_file_to_image(file->mlx_ptr,
